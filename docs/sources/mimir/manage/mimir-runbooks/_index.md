...
The size of the queue is shown on the `Queue Length` dashboard panel on the `Mimir / Reads` dashboard (for the standard query path) or `Mimir / Remote Ruler Reads`
