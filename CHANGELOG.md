...
* [ENHANCEMENT] Query-frontend: Add support for blocking queries based on time range duration using `time_range_longer_than` and `time_range_shorter_than`. #14609
